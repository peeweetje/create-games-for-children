...
<li className="flex-1">
                            <div className="flex flex-col items-center justify-center h-full w-full gap-1 text-xs font-medium text-orange-400" onClick={() => changeLanguage(i18n.language === 'en' ? 'nl' : 'en')}>
                                <Languages size={24} />
