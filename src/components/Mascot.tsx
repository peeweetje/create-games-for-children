        ...
        <div className="fixed bottom-20 md:bottom-4 right-4 flex items-end max-w-[200px] pointer-events-none md:pointer-events-auto z-40">
            <AnimatePresence mode='wait'>
                <motion.div
                    ...
                    className="bg-surface p-4 rounded-2xl rounded-br-none shadow-xl border-2 border-primary-300 mb-2 mr-2"
                >
                    <p className="text-sm font-comic font-medium text-text-700 leading-snug">
                        {message}
                    </p>
                </motion.div>
            </AnimatePresence>
