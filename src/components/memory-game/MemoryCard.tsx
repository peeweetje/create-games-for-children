...
export const MemoryCard = ({ card, onClick }: MemoryCardProps) => {
    ...
    return (
        ...
        >
            ...
            >
                <div className="w-4 h-4 md:w-6 md:h-6 bg-surface rounded-full opacity-50"></div>
            </div>
            ...
            <div
                className={`absolute inset-0 w-full h-full rounded-xl md:rounded-2xl flex items-center justify-center text-2xl md:text-4xl font-bold transition-colors duration-300 ${
                    card.isMatched
                        ? 'bg-gradient-to-br from-success to-success-600 ring-4 ring-success ring-offset-2'
            ...
            >
                {card.isMatched ? (
                    <span className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-success-600 text-lg md:text-xl">✓</span>
                    </span>
                ) : (
