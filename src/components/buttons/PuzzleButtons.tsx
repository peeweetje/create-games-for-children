...
export const PuzzleButtons = ({ 
    ...
    return (
        <div className="mt-2 flex flex-wrap gap-4 justify-center">
            <button
                onClick={onReset}
                className="flex items-center gap-2 px-4 py-2 bg-primary-200 hover:bg-primary-300 text-primary-800 rounded-lg font-semibold transition-colors cursor-pointer text-sm"
            >
