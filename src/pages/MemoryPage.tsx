            ...
            <main className="w-full max-w-2xl flex flex-col items-center gap-4 md:gap-6">
                <div className="w-full flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <span className="text-sm text-text-600 bg-white px-3 py-1 rounded-full shadow-sm">
                            {t('memory.description')}
                        </span>
                    </div>
                </div>

                <div className="w-full border-4 md:border-8 border-white rounded-xl md:rounded-2xl shadow-xl md:shadow-2xl p-2 md:p-4 bg-gradient-to-br from-background to-accent-50">
